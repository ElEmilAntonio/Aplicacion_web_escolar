...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Registrarse como Docente') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                     ...
                     <!--    //INGRESAR La Homoclave -->
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Homoclave" type="text" class="form-control @error('name') is-invalid @enderror" name="Homoclave" value="{{ old('Homoclave') }}" required autofocus>
                        ...
                        <div class="form-group row" style="display: none;">
                            ...
                            <div class="col-md-6">
                                <input id="NumeroControl" type="text" class="form-control @error('name') is-invalid @enderror" name="NumeroControl" value="11000000" required autofocus>
                     ...
                     <!--   //INGRESAR Clave -->
                        <div class="form-group row" style="display: none;">
                            <label for="ClaveCurso" class="col-md-4 col-form-label text-md-right">{{ __('Clave') }}</label>

                            <div class="col-md-6">
                                <input id="ClaveCurso" type="text" class="form-control @error('ClaveCurso') is-invalid @enderror" name="ClaveCurso" value="1234" required autofocus>
